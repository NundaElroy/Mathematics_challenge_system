...
<body>
    @section('content')
    <div id="carouselExampleIndicators" class="carousel slide section-image" data-ride="carousel" data-interval="3000">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{ asset('light-bootstrap/img/Side4.jpg') }}" class="d-block w-100" alt="Slide 1">
            </div>
            <div class="carousel-item">
                <img src="{{ asset('light-bootstrap/img/math-problem.jpg') }}" class="d-block w-100" alt="Slide 2">
            </div>
            <div class="carousel-item">
                <img src="{{ asset('light-bootstrap/img/Side5.jpg') }}" class="d-block w-100" alt="Slide 3">
            </div>
            <div class="carousel-item">
